    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            onClick={() => setShowStealthMode(!showStealthMode)}
            className={`mesh-button ${showStealthMode ? 'neon-border' : ''}`}
          >
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {(['verified', 'private', 'anonymous'] as const).map((level) => (
                      <Button
                        key={level}
                        variant={selectedTrustLevel === level ? "default" : "outline"}
                        size="sm"
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {channels.map((channel) => (
            <Card key={channel.id} className="invite-channel">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      size="sm"
                      variant="ghost"
                      onClick={() => copyInviteCode(channel.inviteCode)}
                    >
      ...
      <div>
        ...
        <div className="space-y-2">
          {trustedPeers.map((peer, index) => (
            <Card key={index} className="mesh-card">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {peer.lastSeen 
                        ? `${Math.round((Date.now() - peer.lastSeen.getTime()) / 60000)}m ago`
                        : 'Never'
                      }
                    </span>
                  </div>
      ...
      <Card className="mesh-card">
        ...
        <CardContent>
          <div className="flex gap-2">
            <Input
              placeholder="Enter invite code (e.g., FILM-VERIFIED-2024)"
