...
const legalContentLibrary: ContentItem[] = [
  ...
  // Internet Archive Public Domain Films
  {
    ...
    media_type: 'movie',
    streaming_url: 'https://archive.org/download/night_of_the_living_dead/night_of_the_living_dead_512kb.mp4',
    is_legal: true,
  ...
  },
  {
    ...
    media_type: 'movie',
    streaming_url: 'https://archive.org/download/Plan9FromOuterSpace/Plan_9_from_Outer_Space_512kb.mp4',
    is_legal: true,
    source: 'Internet Archive',
    duration_minutes: 79,
  ...
  },
  {
    ...
    media_type: 'movie',
    streaming_url: 'https://archive.org/download/metropolis_giorgio_moroder_restored/Metropolis_512kb.mp4',
    is_legal: true,
    source: 'Internet Archive',
